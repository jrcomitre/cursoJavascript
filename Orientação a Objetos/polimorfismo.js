...
const f1 = new Funcionario('Paula', 'Fernandes', 'paula@gmail.com', '819.354.123.55', prog, 'F9083df')

const c1 = new Cliente('Pedro', 'Silveira', 'pedro@gmail.com', '903.244.222.34', 45669.09);

f1.imprimir_dados() // Pessoa - Funcionário

c1.imprimir_dados() // Pessoa - Cliente

...
alunos.sort(); // Ordenando aray de string
console.log(alunos);

var precos = [123.55, 42.27, 546.99, 23.12];
console.log(precos);

precos.sort(function(a, b) {return a - b;}); // Ordenação de Floats (Função Lambda)
console.log(precos);
*/
var idades = [5, 1, 8, 12, 44, 78];


idades.sort(function(a, b) {return a - b;}) // Ordenação de inteiros (Função Lambda)
console.log(idades);
...
//idades.splice(3, 2); // A partir do índice 3 delete 2 elementos
//console.log(idades);

//idades.splice(3, 0, 56, 89); // A partir do índice 3, não delete nenhum, mas adicione 56, 89
//console.log(idades);

//idades.splice(3, 1, 23) // A partir do índice 3 delete 1 elemento e adicione o 23
//console.log(idades);
//idades[3] = 23;
